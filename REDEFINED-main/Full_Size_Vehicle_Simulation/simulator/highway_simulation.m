...
car_safe_dist = 15; %min allowable distance between obstacle vehicles

save_initial_condition = 0;
num_trials = 1000;

save_dir_prefix = "RecedingHorizonPlanning/" + string(num_trials) + "Trials";
for j = 1:num_trials
    ...
    AgentHelper = RDF_highwayAgentHelper(Agent,frs,HLP,'t_plan',t_plan,'t_move',t_move,'t_failsafe_move',t_failsafe_move,...
        'verbose',verbose_level,'save_dir_prefix', save_dir_prefix, 'max_planning_time', 99.0, 'save_initial_condition', save_initial_condition, 'has_time_limit', false); % takes care of online planning
